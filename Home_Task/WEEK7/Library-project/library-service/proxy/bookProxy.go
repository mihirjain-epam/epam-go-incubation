...
func GetBooks() (uint, []models.BookDTO, error) {
	response, err := client.GetRequest(constants.BooksURI, "")
	if err != nil {
...
func GetBook(id int64) (uint, models.BookDTO, error) {
	response, err := client.GetRequest(constants.BooksURI, fmt.Sprint(id))
	if err != nil {
...
func DeleteBook(id int64) (uint, string, error) {
	response, err := client.DeleteRequest(constants.BooksURI, fmt.Sprint(id))
	if err != nil {
...
func AddBook(book models.BookDTO) (uint, string, error) {
	...
	response, err := client.PostRequest(constants.BooksURI, "", bytes.NewReader(serializedBook))
	if err != nil {
...
func UpdateBook(id int64, book models.BookDTO) (uint, string, error) {
	...
	response, err := client.PutRequest(constants.BooksURI, fmt.Sprint(id), bytes.NewReader(serializedBook))
	if err != nil {
		return uint(response.StatusCode), "0", err
	}
	body, err := ioutil.ReadAll(response.Body)
